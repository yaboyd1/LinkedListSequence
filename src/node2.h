...
// functions, all within the namespace assignment_sequence2
//
...
namespace assignment_sequence2 {
    ...
    private:
    	value_type data_field; /* Contains data of node */
    	node* link_field; /* Pointer to the next node */
    };

    // FUNCTIONS for the linked list toolkit
    std::size_t list_length(const node* head_ptr); /* O(n): Calculates how many nodes there are */
